    ...
    <Box className="Box-container">
      ...
      <form onSubmit={handleRegister}>
        <div className="login-box">
          ...
          <TextField className="Text-input" label="Password" type={showPassword ? "text" : "password"} placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} required />
          <span
